...
| Software        | Base Language   | Closed-loop linkages in documentation | Automatic rendering of variable parameters | Primary purpose       |
|-----------------|:---------------:|:-------------------------------------:|--------------------------------------------|-----------------------|
| TriP (2022)     | Python          | yes                                   | no                                         | Kinematics            |
| Pybotics (2019) | Python          | no                                    | no                                         |                       |
| DART            | C++             | X                                     | X                                          | 1972                  |
| CoreRobotics    | C++             | X                                     | X                                          | 1972                  |
| pinocchio       | C++             | X                                     | X                                          | Jacobian computation  |
