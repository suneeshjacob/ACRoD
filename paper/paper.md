...
| Software        | Base Language   | Closed-loop linkages in documentation | Automation level from mere topology        | Primary focus                |
|-----------------|:---------------:|:-------------------------------------:|--------------------------------------------|--------------------------------|
...
| CoreRobotics (2018)| C++             | X                                     | Human intervention needed to build robot   | Computational Algorithms for Real Time Robot Control                           |
