...
Out of the above paths, the computed list of independent paths pertaining to linear velocities can be accessed by the below script:
...
```
which gives the list of all the independent connecting paths pertaining to linear velocities (only link numbers are shown, indexed from 0),

and the computed list of independent paths pertaining to angular velocities can be accessed by the below script:
...
[[0, 1, 3, 4, 6], [0, 1, 3, 5, 6]]
```
which gives the list of all the independent connecting paths pertaining to angular velocities (only link numbers are shown, indexed from 0).
