...
- Locations of joints: $\textbf{r}\_{(1,2)}=2\hat{i}+8\hat{j}$, $\textbf{r}\_{(2,3)}=6\hat{i}+8\hat{j}$, $\textbf{r}\_{(1,2)}=3\hat{i}+10\hat{j}$ and $\textbf{r}\_{(2,3)}=5\hat{i}+10\hat{j}$
- Orientations of joints: $\phi\_{(1,2)}=2$, $\phi\_{(1,3)}=2$, $\phi\_{(2,4)}=2$ and $\phi\_{(3,4)}=2$
