...
p1 = (T_0_1*sympy.Matrix([c1,1]))[:3,0]
p2 = (T_0_2*sympy.Matrix([c2,1]))[:3,0]
p3 = (T_0_3*sympy.Matrix([c3,1]))[:3,0]
p4 = (T_0_4*sympy.Matrix([c4,1]))[:3,0]
p5 = (T_0_5*sympy.Matrix([c5,1]))[:3,0]
p6 = (T_0_6*sympy.Matrix([c6,1]))[:3,0]
...
Omega_matrix = sympy.diff(R, t) * R.T
